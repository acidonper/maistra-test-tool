...
func CreateTestCPObjects(t *testing.T) {
	...
	err := createAppBundle("bookinfo", apps, "controlplane")
	if err != nil {
		util.Log.Error(err)
		t.Error(err)
		t.FailNow()
...
func DeleteTestCPObjects(t *testing.T) {
	...
	apps, _ := strconv.Atoi(testCPApps)
	err := deleteAppBundle("bookinfo", apps, "controlplane")
	if err != nil {
		util.Log.Error(err)
		t.Error(err)
		t.FailNow()
...
func CreateTestDPObjects(t *testing.T) {
	...
	err := createAppBundle("bookinfo", apps, "dataplane")
	if err != nil {
		util.Log.Error(err)
		t.Error(err)
		t.FailNow()
...
func DeleteTestDPObjects(t *testing.T) {
	...
	apps, _ := strconv.Atoi(testDPApps)
	err := deleteAppBundle("bookinfo", apps, "dataplane")
	if err != nil {
		util.Log.Error(err)
		t.Error(err)
		t.FailNow()
